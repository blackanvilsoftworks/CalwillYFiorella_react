...
import ErrorViewer from '../../error/ErrorViewer';
...
const Product = ({ id_product }) => {
    ...
    if (error)      return <ErrorViewer errorMessage={error} />;
    if (!product)   return <ErrorViewer errorMessage={'El producto solicitado no se encuentra disponible o no existe'} />;
