                                            ...
                                            <div id="carousel-children-product1" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product1_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product1_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product1_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-children-product2" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product2_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product2_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product2_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-children-product3" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product3_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product3_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product3_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-children-product4" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product4_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product4_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/children/product4_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-women-product1" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product1_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product1_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product1_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-women-product2" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product2_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product2_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product2_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-women-product3" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product3_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product3_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product3_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-women-product4" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product4_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product4_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/women/product4_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-men-product1" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product1_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product1_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product1_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-men-product2" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product2_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product2_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product2_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-men-product3" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product3_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product3_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product3_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-4">
                                        <div className="card product-card">
                                            <div id="carousel-men-product4" className="carousel slide">
                                                <div className="carousel-inner">
                                                    <div className="carousel-item active">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product4_img1.jpg" alt="Imagen 1" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product4_img2.jpg" alt="Imagen 2" />
                                                    </div>
                                                    <div className="carousel-item">
                                                        <img className="d-block w-100" src="./src/assets/images/productsContainer/men/product4_img3.jpg" alt="Imagen 3" />
                                                    </div>
                                                </div>
