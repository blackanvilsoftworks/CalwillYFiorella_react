...
//         console.log(`${product?.id_product}, ${selectedSize?.id_size}, ${selectedColor?.id_color}`)
        ...
        <div id="product_container" className="product_container container py-3 py-sm-4 py-md-5 rounded-3">
            <div className="row justify-content-center">
                ...
                <div className="col-6 col-lg-6 px-lg-5">
                    ...
                    {/* SELECTOR DE TALLE */}
                    <div className="selector-group">
                        <label>Talle: <strong>{selectedSize?.size}</strong></label>
                        <div className="size-options">
                            {sizes.map(size => (
                                <button
                                    key={size.id_size}
                    ...
                    {availableColors.length > 0 && (
                        <div className="selector-group">
                            <label>
                                Color: <strong>{selectedColor?.colors?.description || 'Seleccioná un color'}</strong>
                            </label>
                            <div className="color-options">
                                {availableColors.map(color => (
                                    <button
                                        ...
                                        <span className="color-label">{color.colors.description}</span>
                                        {color.stock === 0 && (
                                            <span className="no-stock-label">Sin stock</span>
                                        )}
                                    </button>
